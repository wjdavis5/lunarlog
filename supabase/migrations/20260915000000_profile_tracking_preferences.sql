-- Migration: 20260915000000_profile_tracking_preferences.sql
...
--      transferred_to_user_id tolerated-but-never-read handling and
--      #255's unit columns are kept exactly as that body shipped them.
...
-- shipped) other than the additions called out inline below; same
-- 7-argument signature, so a plain create-or-replace applies (no
-- overload fork).
-- ---------------------------------------------------------------------------
