...
class _AcceptInviteSheetState extends State<AcceptInviteSheet> {
  ...
  Widget _buildIntro(BuildContext context, TextTheme textTheme) {
    ...
    if (_previewState == _PreviewState.ready && preview != null) {
      ...
      return Text(
        ...
        l10n.sharingAcceptInvitePreviewIntro(
    ...
    return Text(
      l10n.sharingAcceptInviteNeutralIntro,
    );
  }
  ...
  Widget? _buildPreviewStatus(BuildContext context, TextTheme textTheme) =>
      switch (_previewState) {
        _PreviewState.loading => Row(
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  AppLocalizations.of(context).sharingAcceptInvitePreviewLoading,
        ...
        _PreviewState.error => Text(
            ...
            AppLocalizations.of(context).sharingAcceptInvitePreviewError,
            style: textTheme.bodySmall,
          ),
        _PreviewState.unavailable => Text(
            key: const ValueKey('accept-invite-preview-unavailable'),
            AppLocalizations.of(context).sharingAcceptInvitePreviewUnavailable,
            style: textTheme.bodySmall,
          ),
  ...
  Widget _titleRow(BuildContext context, ThemeData theme) => Row(
        children: [
          ...
          Expanded(
            child: Text(
              AppLocalizations.of(context).sharingAcceptInviteTitle,
    ...
    return Wrap(
      ...
      children: [
        TextButton(
          ...
          child: Text(l10n.sharingAcceptInviteDecline),
        ),
        FilledButton(
          ...
          child: _loading
              ...
              : Text(l10n.sharingAcceptInviteAccept),
        ),
      ],
    );
  }
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: l10n.sharingAcceptInviteNameLabel,
                    hintText: l10n.sharingAcceptInviteNameHint,
                  ),
                ),
                if (_error != null)
