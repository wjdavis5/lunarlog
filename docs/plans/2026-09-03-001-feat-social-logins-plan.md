...
- No unlinking of a sign-in method: it needs a second identity and a re-authentication story; the account keeps every method it has. The admin recovery for a rogue identity is recorded in U6.
