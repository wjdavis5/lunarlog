...
/// `lib/ui/gate/`, `lib/ui/care/` (tranche 3), and `lib/ui/components/`,
/// `lib/ui/overview/`, `lib/ui/insights/` (tranche 4a) down to zero, so
/// those entries are gone and the recorded size dropped by the same amount:
/// 355 (main, after the widget/health/#1003 work) - 134 (tranche 1) - 113
/// (tranche 2) - 56 (tranche 3) - 8 (epic #831 moved `lib/ui/web/dev_banner.dart`
/// onto `AppLocalizations`) - 31 (tranche 4a) = 13. Every remaining entry is
/// another directory's backlog, owned by a different tranche.
const int _initialAllowlistSize = 13;
...
void main() {
  ...
  // `care/`; tranche 4a did `components/`, `overview/`, and `insights/`.
