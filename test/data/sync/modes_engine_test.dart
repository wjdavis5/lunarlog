...
void main() {
  ...
  test(
    ...
    () async {
      ...
      await rig.sync();
      expect(rig.transport.pullCount, pullsBefore + 13,
          reason: 'a full cycle pulls all thirteen tables (Issue #128 adds '
              'care_notes/visit_prep_items; Issue #801 adds guardian_notes; '
              'Issue #522 adds deleted_profiles; Issue #130 adds '
              'day_entry_merge_events; Issue #257 adds profile_tag_registry; '
              'Issue #170 adds day_entry_history)');
